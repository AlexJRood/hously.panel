...
import 'package:hously_flutter/seo/head_tag.dart' as head_tag;
import 'package:hously_flutter/seo/src/seo_html.dart';
...
mixin SeoTreeNode {
  ...
  String text({
    ...
    return '<$tag style="color:transparent;">$text</$tag>$content';
  }
  ...
  String link({
    ...
    return '<div><a $attributes><p style="color:transparent">$anchor</p></a>$content</div>';
  }
