        ...
        child: BackdropFilter(
          ...
          child:  Container(
            ...
            child: ElevatedButton(
              ...
              onPressed: () async {
                await ref.read(networkMonitoringBrowseListProvider.notifier).clearBrowseListsNM();
                ...
                await ref.read(networkMonitoringBrowseListProvider.notifier).applyFilters(ref);
              },
              child: Padding(
