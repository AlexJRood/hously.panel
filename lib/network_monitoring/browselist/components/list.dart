...
import 'package:hously_flutter/network_monitoring/browselist/components/card.dart';
import 'package:intl/intl.dart';
import 'package:get/get.dart';

class BrowseListWidgetNM extends ConsumerWidget {
  final bool isWhiteSpaceNeeded;
  final bool isHidden;
  const BrowseListWidgetNM({super.key, required this.isWhiteSpaceNeeded, required this.isHidden});
        ...
        children: [
          CustomScrollView(
            ...
            slivers: [
              ...
              ref.watch(networkMonitoringBrowseListProvider).when(
