...
import 'package:hously_flutter/widgets/network_monitoring/like/nm_like_section_mobile.dart';
                    ...
                    if (_atTop && notification.overscroll < 0) {
                      ...
                      if (_dragDistance >= _requiredDragDistance) {
                        ref.read(navigationService).beamPop(
                            context); // Zamknij stronę, jeśli próg został przekroczony
                                        ...
                                        child: GestureDetector(
                                          onTap: () => ref
                                            ...
                                            data: {
                                              ...
                                              'initialPage':
                                                  widget.adFeedPop.images.indexOf(
                                                mainImageUrl,
                                              ),
                                            },
                                          ),
                                              ...
                                              children: [
                                                Expanded(
                                                  child: Container(
                                                    ...
                                                    child: MapAd(
                                                      latitude:
                                                          widget.adFeedPop.address.lat,
                                                      longitude: widget
                                                          .adFeedPop.address.lon,
                                                      onMapActivated: () {
                                                        if (!_isMapActivated) {
                                                          _activateMap();
                                                        }
