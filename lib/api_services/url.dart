...
////////////////////////////////////////////////////ADMIN PANEL////////////////////////////////////////////////////
  ...
  static final leadStatus = appendLeadsPanelUrl('statuses/');

  /// Update indexes of status columns (PATCH)
  static final leadUpdateColumn = appendLeadsPanelUrl('update-column-indexes/');

  /// Update transaction order inside column (PATCH)
  static final leadUpdateStatus = appendLeadsPanelUrl('update-statuses/');
