...
import 'package:hously_flutter/modules/notification/notification_mobile_screen.dart';
import 'package:hously_flutter/modules/notification/notification_pc_screen.dart';
...
class _NotificationScreenState extends ConsumerState<NotificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (screenWidth > 800) {
      chatWidget =  NotificationPcScreen();
    } else {
      chatWidget = NotificationMobileScreen(); // Załóżmy, że masz klasę ChatMobile
    }
