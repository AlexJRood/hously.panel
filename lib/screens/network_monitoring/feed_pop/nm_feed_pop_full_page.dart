...
import 'package:hously_flutter/widgets/network_monitoring/like/nm_like_section_full.dart';
...
class NMFeedPopFullPage extends ConsumerStatefulWidget {
  ...
  const NMFeedPopFullPage(
      {super.key, required this.adNetworkPop, required this.tagNetworkPop});
...
class NMFeedPopFullState extends ConsumerState<NMFeedPopFullPage> {
  ...
  void initState() {
    super.initState();
    mainImageUrl = widget.adNetworkPop.images.isNotEmpty
                          ...
                          child: GestureDetector(
                            onTap: () =>
                              ...
                              data: {
                                ...
                                'initialPage':
                                    widget.adNetworkPop.images.indexOf(
                                  mainImageUrl,
                                ),
                              },
                            ),
                              ...
                              Row(
                                children: [
                                  Text(
                                    ...
                                    style: AppTextStyles.interBold.copyWith(fontSize: 26),
                                  ),
                                  const Spacer(),
                                  Text(
                                        ...
                                        Row(
                                          children: [
                                            Text('Liczba pokoi'.tr,
                                                style: AppTextStyles.interRegular.copyWith(fontSize: 14)),
                                            const Spacer(),
                                            Text('${widget.adNetworkPop.rooms}',
                                                style: AppTextStyles.interRegular.copyWith(fontSize: 14)),
                                          ],
                                        ),
                                        const SizedBox(height: 5),
                                        ...
                                        Row(
                                          children: [
                                            Text('Forma własności'.tr,
                                                style: AppTextStyles.interRegular.copyWith(fontSize: 14)),
                                            const Spacer(),
                                            Text(widget.adNetworkPop.marketType,
                                                style: AppTextStyles.interRegular.copyWith(fontSize: 14)),
                                          ],
                                        ),
                                        const SizedBox(height: 5),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text("Informacje dodatkowe".tr,
                                            style: AppTextStyles.interBold.copyWith(fontSize: 20)),
                                        const SizedBox(height: 20),
                                        Row(
                                          children: [
                                            Text('Powierzchnia'.tr,
                            ...
                            children: [
                              ...
                              SizedBox(
                                  ...
                                  child: FullLikeSectionFeedPopNM(
                                      adFeedPopId: widget.adNetworkPop.id,
                                      ref: ref,
                                      context: context)),
                              const Spacer(),
                            ],
                                      ...
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          ...
                                          actions: <Widget>[
                                            TextButton(
                                              onPressed: () {
                                                ref.read(navigationService).beamPop(); // Zamknięcie okna dialogowego
                                              },
