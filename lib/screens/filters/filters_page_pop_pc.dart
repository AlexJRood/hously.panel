...
class FiltersPagePopPc extends ConsumerStatefulWidget {
  final tag;
  const FiltersPagePopPc({super.key, required this.tag});
          ...
          child: Scaffold(
            ...
            body: Stack(
              children: [
                ...
                Center(
                  child: Hero(
                   tag: widget.tag, // need to be change both sides of hero need the same tag 
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        Material(
                                                                          ...
                                                                          child: Text(
                                                                              'Liczba pokoi'.tr,
                                                                              style: AppTextStyles.interMedium.copyWith(color: buttonTextColor, fontSize: 14)),
                                                                        ),
                                                                      ],
                                                                    ),
                                                                    const FilterButton(
