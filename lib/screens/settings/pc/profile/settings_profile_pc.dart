      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(child: HeadingText(text: 'Informacje osobiste'.tr)),
                const Spacer(),
                Container(
                    ...
                    onTap: () {
                      profileState.update((state) {
                        return state.copyWith(
                          values: {
                            ...state.values,
                            'firstName': profileform.firstNameController.text,
                            'lastName': profileform.lastNameController.text,
                      ...
                      if (isPersonalInfoValid) {
                        ...
                        ref.read(profileFormProvider.notifier).resetFields();
                      } else {}
              ...
              children: [
                Expanded(
                  child: GradientPhoneNumberTwoFields(
                    value: "",
                    isSuffix: false,
                    countryCodeController: profileform.countryCodeController,
                    countryCodeFocus: FocusNode(),
                    countryCodeHint: "",
                    phoneNumberHint: "Phone",
                    phoneNumberController: profileform.phoneNumberController,
                ...
                Expanded(
                  ...
                  onChanged: (value) {
                    ref.read(profileFormProvider.notifier).setGender(value);
                  },
                  hintText: 'Gender',
                )),
              ],
              ...
              children: [
                Expanded(
                  child: GradientDropdownCountry(
                    ...
                    onChanged: (value) {
                      ref.read(profileFormProvider.notifier).setCountry(value);
                    },
                  ),
                ),
              ],
