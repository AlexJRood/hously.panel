...
//   );
//   static LinearGradient backgroundGradientRight35 = LinearGradient(
//     colors: [AppColors.backgroundgradient1.withOpacity(0.5), AppColors.backgroundgradient2.withOpacity(0.5),],
//     begin: Alignment.topRight,
//     end: Alignment.bottomLeft,
//   );
...
//   static final LinearGradient adGradient55 = LinearGradient(
//     colors: [
...
//   static const Color backgroundColor = Color(0xFF000000); // Kolor tła
//   static const Color textColorLight = Color(0xFF000000); // Kolor tekstu
//   static const Color textColorDark =
//       Color.fromARGB(255, 255, 255, 255); // Kolor tekstu
//   static const Color backgroundgradient1 = Color.fromARGB(255, 196, 245, 255);
//   static const Color backgroundgradient2 = Color.fromARGB(255, 255, 255, 255);
//   static const Color backgroundOppacity1 = Color.fromARGB(48, 255, 255, 255);
//   static const Color backgroundOppacity2 = Color.fromARGB(49, 178, 182, 201);
//   static const Color sidebargradient1 = Color.fromARGB(255, 131, 165, 172);
//   static const Color sidebargradient2 = Color.fromARGB(255, 199, 205, 255);
...
//   static final TextStyle houslyAiLogo24 = GoogleFonts.inter(
//     fontSize: 24.0,
//     fontWeight: FontWeight.w900,
//     color: AppColors
//         .textColorLight, // Upewnij się, że kolor jest zdefiniowany w AppColors
...
//     static final TextStyle houslyAiLogo30 = GoogleFonts.inter(
//     fontSize: 30.0,
//     fontWeight: FontWeight.w900,
//     color: AppColors
//         .textColorLight, // Upewnij się, że kolor jest zdefiniowany w AppColors
...
//       static final TextStyle interSemiBold14 = GoogleFonts.inter(
//     fontSize: 14.0,
//     fontWeight: FontWeight.w600,
//     color: AppColors
//         .textColorLight, // Upewnij się, że kolor jest zdefiniowany w AppColors
...
//       static final TextStyle interSemiBold16 = GoogleFonts.inter(
//     fontSize: 16.0,
//     fontWeight: FontWeight.w600,
//     color: AppColors
//         .textColorLight, // Upewnij się, że kolor jest zdefiniowany w AppColors
...
//     fontSize: 14.0,
//     fontWeight: FontWeight.w500,
//     color: AppColors.textColorLight, // Upewnij się, że kolor jest zdefiniowany w AppColors
//   );
...
//     static final TextStyle interRegular10 = GoogleFonts.inter(
//     fontSize: 10.0,
//     fontWeight: FontWeight.w400,
//     color: AppColors
//         .textColorLight, // Upewnij się, że kolor jest zdefiniowany w AppColors
...
//   static final TextStyle interLight16 = GoogleFonts.inter(
//     fontSize: 16.0,
//     fontWeight: FontWeight.w300,
//     color: AppColors
//         .textColorLight, // Upewnij się, że kolor jest zdefiniowany w AppColors
