...
import 'package:hously_flutter/portal/browselist/components/button.dart';
    ...
    return AnimatedContainer(
      ...
      child: Stack(
        children: [
          ...
          Positioned.fill(
            child: BrowseListWidget(isWhiteSpaceNeeded: widget.isWhiteSpaceNeeded, isHidden: _isHidden),
          ),
