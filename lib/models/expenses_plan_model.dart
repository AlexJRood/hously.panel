class ExpensesPlanModel {
  ...
  factory ExpensesPlanModel.fromJson(Map<String, dynamic> json) {
    return ExpensesPlanModel(
      id: json['id'],
...
class AvailableYearExpenses {
  final int year;

  AvailableYearExpenses({required this.year});

  factory AvailableYearExpenses.fromJson(Map<String, dynamic> json) {
    return AvailableYearExpenses(
      year: json['year'],
    );
  }
}
