...
import 'package:hously_flutter/state_managers/data/landing_page_provider.dart';
import 'package:hously_flutter/state_managers/services/navigation_service.dart';
import 'package:hously_flutter/theme/apptheme.dart';
import 'package:hously_flutter/widgets/landing_page/landing_page_pc/filters_widget.dart';
            ...
            children: [
              ...
              if (ref.watch(isLocationVisibleProvider))
                const Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: Center(child: LocationSearchWidget()),
                ),
              if (ref.watch(isPropertyVisibleProvider))
                const Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: Center(child: PropertyTypes()),
                ),
              if (ref.watch(isPriceSelectedProvider))
                const Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: Center(child: PriceRangeWidget()),
                ),
              if (ref.watch(isSelectedMeterRangeProvider))
                const Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: Center(child: MeterRangeWidget()),
                ),
            ],
          ),
        ),
