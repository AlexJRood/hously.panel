...
class SaveSearchByClientListViewWidget extends ConsumerWidget {
  final clientId;
  const SaveSearchByClientListViewWidget({super.key, required this.clientId});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final halfScreenSize = screenWidth/2;
                ...
                if (kind == PointerDeviceKind.mouse ||
                  ...
                  ref.read(networkMonitoringFilterButtonProvider.notifier)
                      .loadSavedFilters(ref
                          .read(networkMonitoringFilterCacheProvider.notifier).state); // Load saved filters to buttons
                  ref.read(navigationService)
                      .pushNamedScreen(Routes.networkMonitoring);
                }
              },
              actions: buildPieMenuActionsNMsavedSearch(ref, search, search.id, context),
              child: Center(
                child: Container(
