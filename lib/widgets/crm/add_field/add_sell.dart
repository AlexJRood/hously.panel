...
import 'package:hously_flutter/widgets/crm/add_field/add_offer_section.dart';
...
class AddSellForm extends ConsumerStatefulWidget {
  ...
  @override
  AddSellFormState createState() => AddSellFormState();
}

class AddSellFormState extends ConsumerState<AddSellForm> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Dane ogłoszenie'.tr, style: AppTextStyles.houslyAiLogo24),
                const SizedBox(
                  height: 20,
                ),
                AddOfferCrm(),
                ...
                Text('Dane Transakcji'.tr, style: AppTextStyles.houslyAiLogo24),
                const SizedBox(
                  height: 20,
                ),
                // Form fields
