...
import 'package:hously_flutter/widgets/crm/finance/features/expenses/functions_revenue.dart';
                ...
                Container(
                  ...
                  child: DropdownButton<String>(
                    style: AppTextStyles.interMedium.copyWith(
                        color: theme.textFieldColor), // Apply custom text style
...
void _applyFilters(WidgetRef ref) {
  ...
  ref.read(revenuePlanProvider.notifier).fetchRevenuePlans(
