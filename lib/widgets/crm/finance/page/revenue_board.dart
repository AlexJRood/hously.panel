...
import 'package:hously_flutter/widgets/crm/finance/page/columns_revenue.dart';
...
class _CrmRevenueBoardState extends ConsumerState<CrmRevenueBoard> {
  void _openTransaction(AgentTransactionModel transaction) {
  ...
  void onMove(AgentTransactionModel transaction, String newStatus, int? newIndex) {
    ref
        .read(transactionProvider.notifier)
